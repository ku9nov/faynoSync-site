...
description: Set up your local FaynoSync development environment two ways — a traditional setup with MongoDB and Go, or a Docker-based workflow — and choose the path that best fits how you like to build.
---
