...
description: Set up a local FaynoSync development environment two ways — a traditional MongoDB and Go setup, or a Docker-based workflow. Pick the path that fits.
---
