...
description: Track version adoption, platform distribution, and active users with faynoSync's privacy-first telemetry — via checkVersion and a beacon endpoint.
---
