...
description: Enable Performance Mode in faynoSync to handle thousands of update checks per minute — a Redis-backed cache plus an optional Nginx microcache layer.
---
