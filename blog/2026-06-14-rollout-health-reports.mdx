...
description: Catch failed updates early with faynoSync report ingestion — clients send update, install, and crash failures, aggregated into rollout-health groups.
---
