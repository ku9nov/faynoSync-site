...
description: Add auto updates to your Electron app with faynoSync — custom update flow, native electron-updater integration, code signing, and troubleshooting.
---
