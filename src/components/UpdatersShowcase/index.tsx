...
const updaters: Updater[] = [
  ...
  },
  {
    ...
    tagline: 'Drop-in electron-updater backend — faynoSync serves the *.yml manifests your app reads.',
    color: '#9feaf9',
    color2: '#47848f',
  ...
  },
  {
    ...
    tagline: 'Serves the RELEASES file Squirrel.Windows fetches — full and delta packages, served straight.',
    color: '#f08c3c',
    color2: '#c0561c',
