...
description: Update FaynoSync application metadata such as name, logo, description, and related settings.
---
...
| `download_mode` | string | ❌ | Private apps only: `unlisted` or `strict`, who may [download](./download) artifacts and check for updates |
