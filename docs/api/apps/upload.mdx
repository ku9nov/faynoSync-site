---
title: Upload App
description: Upload FaynoSync application artifacts with version, channel, platform, architecture, and package metadata.
---
...
:::tip Large files
Every file sent to this endpoint passes through faynoSync and the reverse proxy in front of it. For large builds, use [presigned uploads](/docs/presigned-uploads) ([Upload Init](./upload-init) + [Upload Complete](./upload-complete)) to send files directly to object storage.
:::
