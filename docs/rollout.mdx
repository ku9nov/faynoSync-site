...
description: How FaynoSync staged (canary) rollouts work — a server-issued percent and seed, deterministic SDK-side bucketing, and dashboard adoption tracking.
---
# Staged Rollout
