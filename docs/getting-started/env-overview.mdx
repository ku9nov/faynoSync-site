...
| `S3_BUCKET_NAME` | The name of your MinIO bucket for private storage. | `S3_BUCKET_NAME=cb-faynosync-s3` |
| `S3_BUCKET_NAME_PUBLIC` | The name of your MinIO bucket for public storage. | `S3_BUCKET_NAME_PUBLIC=cb-faynosync-s3-public` |
| `S3_ENDPOINT` | The MinIO endpoint URL. | `S3_ENDPOINT=localhost:9010` |
| `S3_ENDPOINT_PUBLIC` | The public MinIO endpoint URL. | `S3_ENDPOINT_PUBLIC=localhost:9010` |
...
| `S3_BUCKET_NAME` | The name of your AWS S3 bucket for private storage. | `S3_BUCKET_NAME=your-private-bucket` |
| `S3_BUCKET_NAME_PUBLIC` | The name of your AWS S3 bucket for public storage. | `S3_BUCKET_NAME_PUBLIC=your-public-bucket` |
| `S3_ENDPOINT` | The AWS S3 endpoint URL. | `S3_ENDPOINT=https://your-bucket-name.s3.amazonaws.com` |
| `S3_ENDPOINT_PUBLIC` | The public AWS S3 endpoint URL. | `S3_ENDPOINT_PUBLIC=https://your-public-bucket.s3.amazonaws.com` |
...
| `S3_BUCKET_NAME` | The name of your DigitalOcean Space for private storage. | `S3_BUCKET_NAME=your-private-space` |
| `S3_BUCKET_NAME_PUBLIC` | The name of your DigitalOcean Space for public storage. | `S3_BUCKET_NAME_PUBLIC=your-public-space` |
| `S3_ENDPOINT` | The DigitalOcean Spaces endpoint URL. | `S3_ENDPOINT=nyc3.digitaloceanspaces.com` |
...
| `S3_BUCKET_NAME` | The name of your GCS bucket for private storage. | `S3_BUCKET_NAME=your-private-gcs-bucket` |
| `S3_BUCKET_NAME_PUBLIC` | The name of your GCS bucket for public storage. | `S3_BUCKET_NAME_PUBLIC=your-public-gcs-bucket` |
...
MINIO_SECURE=false
S3_BUCKET_NAME=cb-faynosync-s3
S3_ENDPOINT=localhost:9010
S3_ACCESS_KEY=
S3_SECRET_KEY=
S3_BUCKET_NAME_PUBLIC=cb-faynosync-s3-public
S3_ENDPOINT_PUBLIC=localhost:9010
...
#S3_ENDPOINT_PUBLIC=https://<bucket_name>.s3.amazonaws.com # for example in us-east-1
