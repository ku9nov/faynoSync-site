...
This setup will start essential services like **MongoDB** and local S3-compatible storage (recommended: **Garage** with `STORAGE_DRIVER=aws`) without running the full API in a container.
